...
Important: Ces estimations sont des points de départ. Ajustez en fonction de vos résultats et consultez un professionnel si nécessaire.`,
    ...
    ar: {
      ...
      subtitle: 'حدد احتياجاتك اليومية من السعرات الحرارية',
      genderLabel: 'الجنس',
      male: 'ذكر',
      female: 'أنثى',
      ...
      activities: {
        '1.2': 'قليل الحركة (قليل أو بدون تمارين)',
        '1.375': 'نشط قليلاً (1-3 أيام/أسبوع)',
        '1.55': 'نشط معتدل (3-5 أيام/أسبوع)',
        '1.725': 'نشط جداً (6-7 أيام/أسبوع)',
        '1.9': 'نشط للغاية (رياضي)',
      },
      goalLabel: 'الهدف',
      goals: {
        lose: 'فقدان الوزن (-500 سعرة)',
        maintain: 'الحفاظ على الوزن',
        gain: 'زيادة الوزن (+500 سعرة)',
      },
      calculate: 'احسب',
      result: 'السعرات اليومية',
      about: 'كيف يعمل',
      aboutText: `تستخدم هذه الآلة الحاسبة معادلة ميفلين-سانت جيور لتقدير معدل الأيض الأساسي (BMR)، ثم تقوم بتعديله بناءً على مستوى نشاطك وأهدافك.

الصيغة:
• الرجال: BMR = 10 × الوزن(كجم) + 6.25 × الطول(سم) - 5 × العمر + 5
• النساء: BMR = 10 × الوزن(كجم) + 6.25 × الطول(سم) - 5 × العمر - 161

يتم ضرب النتيجة بعامل نشاطك ثم تعديلها حسب هدفك:
• فقدان الوزن: -500 سعرة/يوم (≈0.5 كجم/أسبوع)
• الحفاظ: سعرات الصيانة
• زيادة الوزن: +500 سعرة/يوم (≈0.5 كجم/أسبوع)

مهم: هذه التقديرات هي نقاط انطلاق. اضبط بناءً على نتائجك واستشر متخصصاً إذا لزم الأمر.`,
    },
    en: {
